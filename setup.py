...
ext_modules=[
#    Extension("icc.mothurpim.cython_module",
#              sources=["src/./icc.mothurpim/cython_module.pyx"],
#              libraries=["gdal"],
#    )
]
...
setup(
    name='icc.mothurpim',
    version=version,
    description="Python PIM generation package",
    ...
    entry_points={
        'console_scripts':
            ['icc.mothurpim=iccmothurpim:main']
    },
